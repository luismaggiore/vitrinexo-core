...
Desarrollado por <a href="https://www.maggiore.cl" style="color:#8ea5b8;">Maggiore</a>
    ...
    private static function tpl_plan_aviso_vencimiento( array $d ): string
    {
        ...
        $msg_extra = $fundador
            ? '<p style="font-size:14px;color:#1a2335;">Como <strong>Afiliado Original</strong> tienes acceso a un precio especial permanente. Actívalo antes de que venza tu acceso gratuito para no perder ninguna conexión.</p>'
            : '';
